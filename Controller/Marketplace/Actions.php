...
abstract class Actions extends \Magento\Framework\App\Action\Action
{
    ...
    const SELLER_RESOURCE = 'Lofmp_ProductAttachment::manage_attachments';
    ...
    public function __construct(
        ...
        $this->helperData = $helperData?$helperData:\Magento\Framework\App\ObjectManager::getInstance()->create(Data::class);
